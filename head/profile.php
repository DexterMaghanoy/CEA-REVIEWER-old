...
.gradient-custom {
    background: #6fdde8; /* fallback for old browsers */
    background: -webkit-linear-gradient(to right bottom, #6fdde8, #3b8bc8); /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right bottom, #6fdde8, #3b8bc8); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
